...
import { StykedImg, StyledImg, WbnSlide } from './styles/HeroSliderStyles'
    ...
    <WbnSlide className={active ? 'active' :  ''}>
        <StyledImg fluid={slide.featured_media.localFile,childImageSharp.fluid}>
            <div className="wbn-overlay-text">
                ...
                <Link to={slider.acf.slider_button_link}>
                <button type="button">{slide.acf.slider_button_link}</button>
                </Link>
            </div>
        </StyledImg>
    </WbnSlide>
